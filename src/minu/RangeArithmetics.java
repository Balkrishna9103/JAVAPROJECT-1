...
class RangeArithmetics{
	...
	{
		RangeArithmetics rangeArithmetics = new RangeArithmetics();
		rangeArithmetics.divBy5(10,30);
		rangeArithmetics.divBy5And3(5,18);
		rangeArithmetics.sumOfNum(1,5);
		rangeArithmetics.diffOfOddEven(3,9);
	}
}