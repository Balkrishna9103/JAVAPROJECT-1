...
class Test1{
	...
	void div3and5(int startR,int endR){
	for (;startR<=endR;startR++){
		if (startR%3==0 && startR%5==0)
			System.out.println(startR + " is div by 3 & 5");
		else if(startR%3==0)
			System.out.println(startR + " is div by 3");
		else if(startR%5==0)
			System.out.println(startR + " is div by 5");	
	}	
